...
public interface IPlugin {
	 ...
	 */
	void setContext(PhoneGapInterface ctx);

	/**
	 * Sets the main View of the application, this is the WebView within which a
	 * app runs.
	 * 
	 * @param webView
	 *            The WebView
	 ...
	 * 
	 * @param url
	 *            The URL that is trying to be loaded in the webview.
	 * @return Return true to prevent the URL from loading. Default is false.
	 */
	boolean onOverrideUrlLoading(String url);

	PluginFNCArray getActions();
}