...
import eu.mjdev.phonegap.AudioPlayer;
import eu.mjdev.phonegap.api.LOG;
import eu.mjdev.phonegap.api.Plugin;
import eu.mjdev.phonegap.api.PluginResult;

/**
 * This class called by Activity to play and record audio. The file can be local
 * or over a network using http.
 * 
...
public class AudioHandler extends Plugin {
	...
	public static String TAG = "PhoneGapLog - AudioHandler";
	...
	public void setAudioOutputDevice(int output) {
		...
		if (output == 2) {
			...
			LOG.d(this.getClass().getSimpleName(),
					"AudioHandler.setAudioOutputDevice() Error: Unknown output device.");
		}
	}
	...
	public void setVolume(String id, float volume) {
		...
		if (audio != null) {
			...
			LOG.d(this.getClass().getSimpleName(),
					"AudioHandler.setVolume() Error: Unknown Audio Player "
							+ id);
		}
	}
