...
import eu.mjdev.phonegap.NFCUtil;
import eu.mjdev.phonegap.TagWriteException;
...
public class Nfc extends Plugin {
    ...
    public PluginResult execute(String action, JSONArray data, String callbackId) {
        ...
        if (action.equalsIgnoreCase(REGISTER_MIME_TYPE)) {
            ...
            try {
                ...
                NdefRecord[] records = NFCUtil.jsonToNdefRecords(data.getString(0));
    ...
    private void fireTagEvent (Tag tag) {
        ...
        String command = MessageFormat.format(javascriptTemplate, TAG_DEFAULT, NFCUtil.tagToJSON(tag));
        Log.v(TAG, command);
        this.sendJavascript(command);
    }
    ...
    JSONObject buildNdefJSON(Ndef ndef, Parcelable[] messages) {
        ...
        JSONObject json = NFCUtil.ndefToJSON(ndef);
        ...
        if (ndef == null && messages != null) {
            ...
            try {
                ...
                if (messages.length > 0) {
                    ...
                    json.put("ndefMessage", NFCUtil.messageToJSON(message));
                ...
                // shouldn't happen
                Log.e(NFCUtil.TAG, "Failed to convert ndefMessage into json", e);
            }
        }
        return json;
    }
