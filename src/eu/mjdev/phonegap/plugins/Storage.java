	...
	public void executeSql(String query, String[] params, String tx_id) {
		try {
			if (isDDL(query)) {
				...
				this.sendJavascript("phonegap.require('phonegap/plugin/android/storage').completeQuery('"
						+ tx_id + "', '');");
			} else {
			...
			this.sendJavascript("phonegap.require('phonegap/plugin/android/storage').fail('"
					+ ex.getMessage() + "','" + tx_id + "');");
		}
	}
