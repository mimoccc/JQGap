...
public class Device extends Plugin {
    ...
    public static String PhoneGapVersion = "1.7.0";              // PhoneGap version
    public static String platform = "Android";                  // Device OS
    public static String uuid;                                  // Device Guid
    ...
    private void initTelephonyReceiver() {
        ...
        final PhoneGapInterface myctx = this.ctx;
    ...
    /**
     * Get the device's Universally Unique Identifier (Guid).
     * 
     * @return
     */
    ...
    public String getPhoneNumber(){
    	TelephonyManager tMgr =(TelephonyManager)this.ctx.getSystemService(Context.TELEPHONY_SERVICE);
