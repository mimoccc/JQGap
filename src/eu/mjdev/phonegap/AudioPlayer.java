...
import eu.mjdev.phonegap.plugins.AudioHandler;

public class AudioPlayer implements OnCompletionListener, OnPreparedListener, OnErrorListener {
    private static final String LOG_TAG = "PhoneGapLog - AudioPlayer";
	...
	public void startRecording(String file) {
		if (this.mPlayer != null) {
			...
			//this.handler.sendJavascript("phonegap.require('phonegap/plugin/Media').onStatus('" + this.id + "', "+MEDIA_ERROR+", { \"code\":"+MEDIA_ERR_ABORTED+"});");
	...
	public void seekToPlaying(int milliseconds) {
		if (this.mPlayer != null) {
		    ...
		    //this.handler.sendJavascript("phonegap.require('phonegap/plugin/Media').onStatus('" + this.id + "', "+MEDIA_POSITION+", "+milliseconds/1000.0f+");");
		}
	}
	...
	public void pausePlaying() {
		if (this.state == MEDIA_RUNNING) {
			...
			//this.handler.sendJavascript("phonegap.require('phonegap/plugin/Media').onStatus('" + this.id + "', "+MEDIA_ERROR+", { \"code\":"+MEDIA_ERR_NONE_ACTIVE+"});");			
		}
	}
	...
	public long getCurrentPosition() {
		if ((this.state == MEDIA_RUNNING) || (this.state == MEDIA_PAUSED)) {
		    ...
		    //this.handler.sendJavascript("phonegap.require('phonegap/plugin/Media').onStatus('" + this.id + "', "+MEDIA_POSITION+", "+curPos/1000.0f+");");
			return curPos;
		} else  
			return -1; 
	}
	...
	public void onPrepared(MediaPlayer mPlayer) {
		...
		//this.handler.sendJavascript("phonegap.require('phonegap/plugin/Media').onStatus('" + this.id + "', "+MEDIA_DURATION+","+this.duration+");");
	...
	public boolean onError(MediaPlayer mPlayer, int arg1, int arg2) {
		...
		//this.handler.sendJavascript("phonegap.require('phonegap/plugin/Media').onStatus('" + this.id + "', { \"code\":"+arg1+"});");
		return false;
	}
	...
	private void setState(int state) {
		if (this.state != state) {
			//this.handler.sendJavascript("phonegap.require('phonegap/plugin/Media').onStatus('" + this.id + "', "+MEDIA_STATE+", "+state+");");
		}
