 ...
 */
public class PhoneGapWebViewClient extends WebViewClient {
    
    private static final String TAG = "PhoneGap";
    DroidGap ctx;
     ...
     * @param ctx
     */
    public PhoneGapWebViewClient(DroidGap ctx) {
        this.ctx = ctx;
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        ...
        // All else
            ...
            // If our app or file:, then load into a new webview container by starting a new instance of our activity.
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        if (!url.equals("about:blank")) {
        	// DEVICE READY IF NEEDED
            this.ctx.postMessage("onNativeReady", null);
        }

        // Make app visible after 2 sec in case there was a JS error and JS never initialized correctly
                ...
                public void run() {
                    try {
                        ...
                        ctx.runOnUiThread(new Runnable() {
                            public void run() { ctx.appView.setVisibility(View.VISIBLE); }
                        });
